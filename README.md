...
This is a remake of the Vanilla Terrain to a 1:1 scale that can then be
modified to include new features including some made by the Terra team!
...
[`biome-providers/presets/vanilla.yml`](./biome-providers/presets/vanilla.yml)
